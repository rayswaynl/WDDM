...
- **10 worked building designs** — five fortification layouts each for the **Artillery Radar** (concrete shield, camo concealment, obstacle belt, watchtower ring, boom-gate checkpoint) and the **Reserve** (concrete yard, double-boom motor-pool gate, camo compound, obstacle perimeter, floodlit walled yard), all 0 AI.
