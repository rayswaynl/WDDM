...
- **`M252_US_EP1.png`** — US **M252 81mm mortar**, top-down. A small round baseplate with a thin tube angled up from centre and a two-legged bipod V straddling it. Tiny footprint, dark metal/olive. Tube points UP. *(The Soviet **2B14 82mm mortar** `2b14_82mm_TK_EP1` is aliased to this sprite — near-identical from above; no separate file needed.)*
